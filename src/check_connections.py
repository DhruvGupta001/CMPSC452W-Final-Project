...
loop_seconds = 5  # seconds to wait in between each monitor loop
disconnect_time = 1800  # time to wait before client is rendered disconnected
__checking = True  # flag that indicates whether or not to notice new connections
__broadcast = True  # toggle for broadcasting to a web service
__writing = True  # toggle for writing connections to a file
...
__printing = True # flag to indicate if script prints output
connected_file = "resources/connected_file.json"  # file to log connections
log_file = "resources/unknown_connections.log"  # log file for unknown devices
...
if __name__ == "__main__":
    ...
    print("monitoring connections to network...")
